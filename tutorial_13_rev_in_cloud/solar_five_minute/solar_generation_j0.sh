...
#SBATCH --job-name=solar_generation_j0  # job name
#SBATCH --nodes=1  # number of nodes
#SBATCH --output=/scratch/reV-tutorial/tutorial_13_rev_in_cloud/solar/logs/stdout/solar_generation_j0_%j.o
#SBATCH --error=/scratch/reV-tutorial/tutorial_13_rev_in_cloud/solar/logs/stdout/solar_generation_j0_%j.e
#SBATCH --qos=normal
